...
The PGP currently has \totalDatedDocs\hspace{0.25ex} dated documents (\percentDatedDocs\hspace{0.25ex} of all documents). Of these, \totalDateOnDoc\hspace{0.25ex} have an explicit date and \totalInferredDate\hspace{0.25ex} have been dated inferentially. Since dates are usually not precisely known, the range of possible dating can be quite large (Table \ref{table:date-precision}, Figure \ref{fig:docs_dating_combined}).
