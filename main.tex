...
\begin{figure}[!hbt]
  ...
  \caption{This chart shows the distribution of documents by date. The green line graphs the totals for documents by year, based on a midpoint date for date ranges (scale to right). The stacked bar chart indicate totals for dated documents by decade with any possible overlap of the date range (scale to left).}
