...
\begin{quote}
The Princeton Geniza Project (PGP) is a database devoted to the documentary sources of the Cairo Geniza. Beginning in 2020, as the database approached its thirty-fifth anniversary, a partnership between Princeton Geniza Lab (PGL) and the Center for Digital Humanities (CDH) launched a major overhaul of the database, updating and connecting previously siloed data and modernizing data formats, workflows, and interfaces. Now, for the first time, datasets have been published from this long-running project, with the hope of bringing the materials to a wider community of digital and computational humanists and making them more tractable. This essay describes the project’s history, explains the structure of the data, and provides context for their nuances, unevenness, and gaps. We provides an overview of the data, including the relationship between fragments and documents; descriptive metadata (types, descriptions and tags); languages and scripts; dates and calendars; and scholarship records including transcriptions and translations. Finally, we share our analysis of the rate of change of the data and plans for publishing versions. This essay is intended both as a reference for anyone who wants to work with the data and inspiration to encourage interest in this fascinating, rich data.    
\end{quote}
    \vspace{0.9cm}    
\end{center}
...
\begin{figure}[h!]
  ...
  \centering
  \caption{An image of an exemplary geniza letter, showing the fragmentary material and handwritten text at multiple angles using the space (Letter: T-S 12.392, Oct. 1103 CE. \textit{Princeton Geniza Project}, PGPID 9690).}
  \label{fig:pgpid9690}
\end{figure}
...
\begin{table}
\begin{center}
\caption{Geniza documents are most frequently written in Hebrew and Arabic scripts and languages, but include small numbers of documents in unidentified languages and scripts.}
