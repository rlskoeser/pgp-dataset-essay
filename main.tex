...
\begin{figure}[!hbt]
  ...
  \centering
  \caption{This database diagram shows the many-to-many relationship between documents and fragments in the PGPv4 database.
    \small
...
\caption{A chart of documents by type shows the distribution across these controlled types; the most common types are letters and legal documents.}
