...
\centering
\caption{Charting documents in PGP by year with cumulative total shows a visible spike between 2016 and 2018 due to the shift from transcription to description.}
...
\begin{figure}[!hbt]
  ...
  \caption{Documents are dated by a variety of calendars.}
...
\begin{table}
\begin{center}
\caption{PGP draws content from a variety of scholarship sources.}
